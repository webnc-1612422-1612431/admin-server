...
CREATE TABLE `user` (
  ...
  `facebookid` longtext DEFAULT NULL,
  `googleid` longtext DEFAULT NULL,
  `lostpasstoken` longtext DEFAULT NULL,
  `lostpasstokenexpired` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `user` VALUES (1,'tbngoc.khtn@gmail.com','1','admin','Trần Bá Ngọc','null','null','IT',10,'null','',NULL,NULL,NULL);
...
-- Dump completed on 2019-12-02 17:31:51
